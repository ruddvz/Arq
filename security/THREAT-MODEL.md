...
| Zip bomb                                       | Not yet mitigated   | Planned: `ARQ-238` (`backlog/issues/238-security-implement-resource-size-and-expansion-limits.md`).                                                                                                                                                                                                 |
| Path traversal                                 | Not yet mitigated   | No file-import code exists yet to have this bug.                                                                                                                                                                                                                                                    |
| Parser memory exhaustion                       | Not yet mitigated   | Same `ARQ-238` resource/expansion-limit plan covers this.                                                                                                                                                                                                                                           |
