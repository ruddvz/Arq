# inspect: build geometry property group

**Issue ID:** ARQ-131
**Phase:** Phase 2
**Epic:** Inspection
**Priority:** normal
**Suggested labels:** type: feature, area: inspect, priority: normal, state: blocked
**Dependencies:** ARQ-130
