...
add(['V3-091','V3-097','V3-098'], NEW,'packages/editor-shell/src/inference-engine.ts','rankCandidates')
add(['V3-090'], NEW,'packages/editor-shell/src/snap-candidate-collection.ts','collectSnapCandidates')
add(['V3-092'], PRE,'packages/editor-shell/src/snap-candidate-collection.ts','findIntersectionSnaps')
add(['V3-093','V3-094'], PRE,'packages/editor-shell/src/snap-candidate-collection.ts','findPerpendicularSnaps')
add(['V3-095'], PRE,'packages/editor-shell/src/snap-candidate-collection.ts','findExtensionSnaps')
add(['V3-096'], PRE,'packages/editor-shell/src/snap-candidate-collection.ts','findGridSnap')
...
add(['V3-138'], PRE,'packages/design-system/src/shell/inspector-groups.ts','buildEmptyInspectorGroups')
...
add(['V3-142'], DIVERGENT,'packages/workspace/src/responsive.ts','tablet-landscape')
add(['V3-143'], DIVERGENT,'packages/workspace/src/responsive.ts','tablet-portrait')
...
add(['V3-148'], DIVERGENT,'packages/workspace/src/keyboard-map.ts','shouldHandleShortcut')
