...
test('resolves Rust crate, direct module, self and local module candidates deterministically', () => {
  ...
  assert(
    rustUseModuleCandidates('rust/arq-core/src/lib.rs', 'crate::hashing').includes(
