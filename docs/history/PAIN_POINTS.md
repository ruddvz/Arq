...
> **Folded forward.** `ARQ-MASTER-PRODUCT-PLAN-v0.1.md` (this folder) §4 converted this
> into testable requirements; the current source of truth is
> [`docs/product/ARQ-COMPLETE-PRODUCT-ENGINEERING-BLUEPRINT-v1.0.md`](../product/ARQ-COMPLETE-PRODUCT-ENGINEERING-BLUEPRINT-v1.0.md).
> Kept here as background/citations for points not repeated verbatim there.
