...
> **Superseded.** `ARQ-MASTER-PRODUCT-PLAN-v0.1.md` (this folder) §12 first replaced
> this. The design system is now implemented as real tokens/icons at
> [`design/tokens.json`](../../design/tokens.json), [`design/tokens.css`](../../design/tokens.css),
> and [`design/icon-manifest.json`](../../design/icon-manifest.json) (40 SVG icons),
> documented in [`docs/design/DESIGN-SYSTEM.md`](../design/DESIGN-SYSTEM.md). Kept
> here as an earlier draft for history.
