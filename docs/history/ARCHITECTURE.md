...
> **Superseded twice over.** `ARQ-MASTER-PRODUCT-PLAN-v0.1.md` (this folder) §16 first
> replaced this with a TypeScript/web-first architecture; `docs/adr/` 0003, 0007, and
> 0009 have since refined that further (modular monolith, purpose-built 2D geometry
> rather than OpenCascade for everything, OpenCascade scoped to a narrow boundary).
> Current source of truth: [`docs/product/ARQ-COMPLETE-PRODUCT-ENGINEERING-BLUEPRINT-v1.0.md`](../product/ARQ-COMPLETE-PRODUCT-ENGINEERING-BLUEPRINT-v1.0.md)
> and `docs/architecture/`. Kept here as an earlier draft for history.
