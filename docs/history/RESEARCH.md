...
> **Superseded.** This was the first-pass research draft. It was superseded once by
> `ARQ-MASTER-PRODUCT-PLAN-v0.1.md` (this folder) §17–18, and current source of truth
> is now [`docs/product/ARQ-COMPLETE-PRODUCT-ENGINEERING-BLUEPRINT-v1.0.md`](../product/ARQ-COMPLETE-PRODUCT-ENGINEERING-BLUEPRINT-v1.0.md).
> Kept here as an early draft for history.
