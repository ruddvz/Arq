...
> was replaced by `ARQ-MASTER-PRODUCT-PLAN-v0.1.md` (this folder) with the opposite
> call — web-first. Since then, `ARQ-EXECUTION-PLAN-v0.2.md` (this folder) and
> `docs/adr/0001-web-first-editor.md`/`0015-native-ipad-strategy.md` have narrowed
> this further: browser editor first, native iPad explicitly deferred. Current source
> of truth: [`docs/product/ARQ-COMPLETE-PRODUCT-ENGINEERING-BLUEPRINT-v1.0.md`](../product/ARQ-COMPLETE-PRODUCT-ENGINEERING-BLUEPRINT-v1.0.md).
> Kept here as an earlier draft for history.
